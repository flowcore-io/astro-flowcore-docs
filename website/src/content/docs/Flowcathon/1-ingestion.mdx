...
<ol>
  <li>
    ...
    :::note
      You can name the data core `flowcathon`, the flow-type `ingestion.0`, and the event-types: `ingestion.challenge-a-ingested.0,ingestion.challenge-b-ingested.0,ingestion.challenge-c-ingested.0`.
    :::
  ...
  <li>
    ...
    :::note
      ...
      - generated transformer secret value: **can be found in the dedicated [discord channel](https://discord.gg/b9c7dRjR) for the workshop**
    :::
  ...
  <li>
    ...
    Verify these resources have been created, please visit your [tenant page](/guides/organization/switch-between-organizations/), and the scenario page
  ...
  <li>
    ...
    This key is used to ingest data into your tenant. Please copy the key, as you will need it in the next step. You can read more about the api keys [here](/flowcore-cli/auth-management-cli/).

    Next, go to the [ingestion page](https://flowcore.io/f/ingestion-channels), and generate a webhook ingestion url, as shown [here](/guides/ingestion/ingestion-options/).
  </li>
</ol>
</Steps>
