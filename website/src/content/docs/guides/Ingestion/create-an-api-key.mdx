...
To generate an API key, [navigate to your organization settings](/guides/2-organization/2navigate-to-organization-settings), and scroll down to __Api Keys__
...
And there you have it! You have successfully created an API key, that you can use to authenticate your [ingestion channels](/guides/4-ingestion/2ingestion-options)

Keep in mind that you can always [delete the created key](/guides/4-ingestion/4delete-an-api-key), and create a new one if you feel that it has been compromised.