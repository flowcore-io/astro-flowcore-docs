...
import CreateOrganizationDialogImage from "../../../../assets/guides/organization/create-an-organization/create-an-organiation-dialog.png";
import CreateOrganizationImage from "../../../../assets/guides/organization/create-an-organization/create-an-organization.png";
import CreatedAnOrganizationImage from "../../../../assets/guides/organization/create-an-organization/created-an-organization.png";

<Card title="Do you have an account?" icon="information">
    If you do not have an account, please refer to the [Create an account](/guides/1-account/1create-an-account).
</Card>
...
Notice that you are automatically added to the new organization as a contributor, with the role of `Owner`. You can now [invite other users to the organization](/guides/2-organization/3invite-user-to-organization) and assign them roles as needed.

The next step is to [create a data core](/guides/3-data-core/2create-data-core) for the organization, so that you can prep for receiving data.