...
import CreateOrganizationDialogImage from "../../../../assets/guides/create-an-organization/create-an-organiation-dialog.png";
...
<Image alt={"The dialog that pops up after selecting 'New Organization'. This requests an organization name"} src={CreateOrganizationDialogImage}/>

4. After creating the organization, you will be automatically redirected to the new organization's profile page.
<Image alt={"The dialog that pops up after selecting 'New Organization'. This requests an organization name"} src={CreatedAnOrganizationImage}/>
