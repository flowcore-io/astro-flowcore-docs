...
import CreateOrganizationImage
    from "../../../../assets/guides/organization/create-an-organization/create-an-organization.png";
import CreateOrganizationDialogImage
    from "../../../../assets/guides/organization/create-an-organization/create-an-organiation-dialog.png";
import CreatedAnOrganizationImage
    from "../../../../assets/guides/organization/create-an-organization/created-an-organization.png";
