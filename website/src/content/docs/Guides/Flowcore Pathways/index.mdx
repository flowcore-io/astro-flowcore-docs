...
const pathwaysBuilder = new PathwaysBuilder({
...
const pathways = pathwaysBuilder.register({
  flowType: "user",
  eventType: "created",
...
const pathways = new PathwaysBuilder({
  ...
  tenant: "your-tenant",
  dataCore: "your-data-core",
  dataCoreDescription: "User service events",
  ...
  .register({
    flowType: "user",
    flowTypeDescription: "User lifecycle",
    eventType: "created",
...
Calling `await pathways.provision()` provisions enabled resources and the named managed pathway. Flowcore controls delivery in production managed mode. Provisioning is additive and does not remove resources that are no longer registered in code.
