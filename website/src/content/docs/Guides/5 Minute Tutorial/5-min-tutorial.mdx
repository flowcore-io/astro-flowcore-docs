...
Create `schemas.ts` to define the structure of your events:
...
Inside `index.ts` set up a simple HTTP server with a POST endpoint that receives events from the Flowcore platform:
