...
Flowcore is a simplified approach to achieve Event Sourcing and CQRS, by using paradigms that every web dev is familiar with.
...
The feature that we like to highlight is replayability. Which is where you replay the events stored in Flowcore to create or update services.
