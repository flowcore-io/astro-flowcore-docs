...
- [Data Cores](/guides/architecture/primitives/#data-core) - Data core resources `frn::<tenant>:data-core/<resource-id>`, `read, write, fetch, ingest, sensitive-data-fetch`
- [Flow Types](/guides/architecture/primitives/#flow-type) - Flow type resources `frn::<tenant>:flow-type/<resource-id>`, `read, write, fetch, ingest, sensitive-data-fetch`
- [Event Types](/guides/architecture/primitives/#event-type) - Event type resources `frn::<tenant>:event-type/<resource-id>`, `read, write, fetch, ingest, sensitive-data-fetch`
