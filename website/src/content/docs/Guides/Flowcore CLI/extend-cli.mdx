...
:::caution[Important]
  The assumption is that you are familiar with the oclif framework and the Flowcore CLI. If you are not, we suggest you read the [oclif documentation](https://oclif.io/docs/introduction.html) and the [Flowcore CLI documentation](/guides/flowcore-cli/stream-cli/).
:::
