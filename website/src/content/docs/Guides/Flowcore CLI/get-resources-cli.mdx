...
To get all tenants you have access to, you can use the `flowcore get tenant` command. This command will get all tenants you have access to.
...
To get scenarios, you can use the `flowcore get scenario --tenant <tenant-name>` command. This command will get all scenarios for the specified tenant.
...
To get adapters, you can use the `flowcore get adapter --tenant <tenant-name> --scenario <scenario-name>` command. This command will get all adapters for the specified tenant and scenario.
