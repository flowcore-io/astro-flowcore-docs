...
<Card title="Information" icon="information">
  ...
  Adjusting event time also affects delivery. An event inserted behind a consumer cursor is not delivered unless that Data Pathway source is restarted from an earlier position.
</Card>
