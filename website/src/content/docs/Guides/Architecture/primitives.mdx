...
A scenario in Flowcore is a collection of pipelines or a set of services that transform or process data.
...
Transformers are the data processing engines of Flowcore. They run in a transformer shell and can be developed for specific cases or created as configurable runtimes for reuse.
