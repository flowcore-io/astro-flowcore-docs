...
- Event streaming through the CLI, SDK, or managed Data Pathways
...
5. Data Pathway: Managed delivery from selected event types to an application endpoint
6. Read Model: Database for storing processed data for specific use-cases
