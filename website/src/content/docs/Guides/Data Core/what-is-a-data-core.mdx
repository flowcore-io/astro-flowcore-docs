...
- `Private`
  - Any collaborators you [invite to your organization](/guides/organization/invite-user-to-organization/) can access your private Data Cores. __They cannot send data to your Data Core without an [API Key](todo) that you have granted them__
