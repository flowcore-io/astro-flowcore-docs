...
These strengths let you ingest data before deciding every downstream use. A [Data Pathway](/guides/flowcore-pathways/) can later deliver selected events from the Data Core to an application.
> Bear in mind that __the data is never altered__. You retain the full event history; consuming an event copies it to the application without changing the stored event.

To send data to a Data Core, use an [ingestion channel](/guides/ingestion/what-is-an-ingestion-channel/).
...
- `Public`
  - Anyone using Flowcore can subscribe to your public Data Cores and access the data within it. __They cannot send data to your Data Core without an [API key](/guides/ingestion/create-an-api-key/) that you have granted them__
- `Private`
  - Any collaborators you [invite to your organization](/guides/organization/invite-user-to-organization/) can access your private Data Cores. __They cannot send data to your Data Core without an [API key](/guides/ingestion/create-an-api-key/) that you have granted them__
